<?php
  ...
  $session::changeID();
    ...
    echo('<script type="text/javascript" src="/SYSTEM/JS/forms.js"></script>');
    echo('<script src="/PAGES/REGISTER/JS/register1.js"></script>');

    echo ("<pre>");
    print_r($_REQUEST);
    echo ("/<pre>");

    $str = '<script>'.'createRegisterPage('.$_REQUEST["username"].','.$_REQUEST["pass1"].');</script>';
    echo($str);
