    ...
    if(!empty($_POST['username']) && !empty($_POST['pass'])) {
        ...
        if(empty($check)) {
            ...
            if(!empty($data_user)) {
                ...
                header("Location: ../NotePage/note.php");
            } else {
          ...
          <header class="row block-1">
            ...
            <div class="row form-row">
                <form class="col-md-6 mx-auto form-cont" method="POST">
                    ...
                    <button type="submit" onClick='location.href="../RegPage/index.html"' class="btn btn-primary mb-2 btn btn-lg">Registration</button>
            </div>
        </div>
