    ...
    <body>
        ...
        <div class="midle">
            <form class="pole"> 
                ...
                <a class="btn btn-info btn-lg active " href="https://wdb-ilya-sosorev.c9users.io/New%20work/colornote/registr_page/registr.html?pole_user=&pole_password=&pole_confirm_password=&pole_email=&button_id=" >Register</a>
            </form>
        </div>
        <div class="down">
