...
//Данные поступающие из формы логинации
$added_user_nickname = $_REQUEST["username"];
...
$report_email = mysqli_query($connection, $conformity_query_email);
	...
	$insert_new_account_query = "INSERT INTO $db_name (user_nickname, user_password, user_email) VALUES('$added_user_nickname', MD5('$added_user_password'), '$added_user_email')";
